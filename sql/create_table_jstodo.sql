...
DROP TABLE IF EXISTS `jstodo`;
CREATE TABLE IF NOT EXISTS `jstodo` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `date` date NOT NULL COMMENT '期限日',
  `item` varchar(50) NOT NULL COMMENT 'TODO項目',
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '完了フラグ',
